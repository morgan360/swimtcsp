...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if connection:
            try:
                with connection.cursor() as cursor:
                    ...
                    with open('import_csv/users.csv', 'w', newline='', encoding='utf-8') as csvfile:
        ...
        input_file = 'import_csv/users.csv'
        output_files = ['import_csv/roles_output_batch1.csv', 'import_csv/roles_output_batch2.csv', 'import_csv/roles_output_batch3.csv', 'import_csv/roles_output_batch4.csv']
