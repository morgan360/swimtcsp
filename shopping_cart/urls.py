...
urlpatterns = [
    ...
    path('rebooking/', views.rebooking_page, name='rebooking_page'),
    ...
    path('confirm-rebooking/<int:swimling_id>/<int:product_id>/', views.direct_rebooking, name='confirm_rebooking'),
